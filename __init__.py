...
game_name = "Hitchhiker's Guide to the Galaxy"


class HHGG(MycroftSkill):
    save_file = expanduser(join("~", ".hhgg.save"))
    playing = False
    container = None
    ...
    def initialize(self):
        ...
        self.game_data = join(self.root_dir, 'hhgg.z5')
